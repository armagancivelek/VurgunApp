    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Box(
                    modifier = Modifier
                        .background(RemoveColor, CircleShape)
            ...
            Row(
                ...
                val (ms1Color, msXColor, ms2Color) = when (selectedBet.betType) {
                    "home" -> Triple(YellowColor, TealColor, TealColor)
                    "draw" -> Triple(TealColor, YellowColor, TealColor)
                    "away" -> Triple(TealColor, TealColor, YellowColor)
                    else -> Triple(TealColor, TealColor, TealColor)
                }
