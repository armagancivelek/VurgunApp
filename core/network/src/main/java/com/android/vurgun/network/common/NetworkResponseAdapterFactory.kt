...
import com.android.vurgun.network.internal.DeferredNetworkResponseCallAdapter
import com.android.vurgun.network.internal.NetworkResponseCallAdapter
...
public class NetworkResponseAdapterFactory : CallAdapter.Factory() {
    override fun get(returnType: Type, annotations: Array<Annotation>, retrofit: Retrofit): CallAdapter<*, *>? {
        ...
        return when (getRawType(returnType)) {
            Deferred::class.java -> {
                DeferredNetworkResponseCallAdapter<Any, Any>(successBodyType, errorBodyConverter)
            }
            Call::class.java -> {
                NetworkResponseCallAdapter<Any, Any>(successBodyType, errorBodyConverter)
            }
            else -> null
        }
    }
